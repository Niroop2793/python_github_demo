...
class test_me_app2(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.driver.get("https://lkmdemoaut.accenture.com/TestMeApp/fetchcat.htm")
...
if __name__ == "__main__":
    ...
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(output='/niroopu da/package_practice'))
